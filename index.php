  ...
  <nav class="site-nav">
    ...
    <div class="container">
      ...
      <div class="site-navigation">
        ...
        <a href="index.php" class="logo m-0">Info Kost<span class="text-primary">.</span></a>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mx-auto text-center">
          ...
          <div class="intro-wrap">
            ...
            <p class="text-white">Selamat datang di infoKost.id, platform informasi kost terdepan yang didedikasikan untuk memudahkan pencarian tempat tinggal yang nyaman dan terjangkau. Info Kost menyajikan layanan yang lengkap dan informatif bagi para pencari kost, mahasiswa, dan pekerja yang sedang mencari tempat tinggal sementara.</p>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <div class="card" style="width: 18rem;">
        ...
        <img src="img/tahun_baru.jpg" class="card-img-top" alt="Event Diskon Kost 2">
    ...
    <div class="col-md-4">
      ...
      <div class="card" style="width: 18rem;">
        ...
        <img src="img/pengguna_baru.jpg" class="card-img-top" alt="Event Diskon Kost 3">

    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center vh-50">
            ...
            <div class="col-md-8 bg-white p-1">
                ...
                <form class="text border border-light p-5" action="php/properti-edit_admin_proses.php?id_kost=<?php echo $d['id_kost']; ?>" method="post" enctype="multipart/form-data">

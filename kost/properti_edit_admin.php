...
<div class="container">
  <div class="row"></div>
    <div class="col-md-10">
      ...
      <form class="text-center border border-light p-5" action="php/properti-edit_admin_proses.php?id_kost=<?php echo $d['id_kost']; ?>" method="post" enctype="multipart/form-data">
        <h3>Ubah Kost</h3>
        <hr>
